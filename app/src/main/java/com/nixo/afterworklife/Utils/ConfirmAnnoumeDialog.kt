...
class ConfirmAnnoumeDialog : BaseDialog{
    ...
    fun setConfirmOnClickListener(confirmOnClickListener: ConfirmOnClickListener) :ConfirmAnnoumeDialog{
        this.confirmOnClickListener = confirmOnClickListener
        return this
    }

    private fun init(context: Context) {
        val view = LayoutInflater.from(context).inflate(R.layout.dialog_cetificate__annoume_confirm, null)
        setContentView(view)
