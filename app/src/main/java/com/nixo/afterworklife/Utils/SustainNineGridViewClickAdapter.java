...
import java.util.List;
     ...
     * 作    者：Sustain
     * 版    本：1.0
     * 创建日期：2019-11-21 20:08:51
     * 描    述：
     * 修订历史：
     * ================================================
     */
   public class SustainNineGridViewClickAdapter extends NineGridViewAdapter {

        private int statusHeight;

        public SustainNineGridViewClickAdapter(Context context, List<ImageInfo> imageInfo) {
