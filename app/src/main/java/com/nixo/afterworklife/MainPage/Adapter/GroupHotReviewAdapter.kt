...
class GroupHotReviewAdapter(var context: Context, layout:Int, data: MutableList<LocationDataItem>) : BaseAdapter<LocationDataItem>(context,layout,data){
...
//            intent.putExtra("userId",mDataList[position])
        ...
        tvNum.text = "${mDataList[position].members}/${mDataList[position].max_member}"
