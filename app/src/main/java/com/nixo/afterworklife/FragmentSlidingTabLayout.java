...
public class FragmentSlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public FragmentSlidingTabLayout(Context context) {
        this(context, null, 0);
    }

    public FragmentSlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FragmentSlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setViewPager(ViewPager vp, String[] titles, FragmentActivity activity, ArrayList<Fragment> fragments) {
        if (vp == null) {
            throw new IllegalStateException("ViewPager can not be NULL !");
        }
        ...
        this.mViewPager = vp;
        this.mViewPager.setAdapter(new InnerPagerAdapter(activity.getSupportFragmentManager(), fragments, titles));
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mUnderlineHeight > 0) {
            mRectPaint.setColor(R.drawable.jb_orange);
            if (mUnderlineGravity == Gravity.BOTTOM) {
                canvas.drawRect(paddingLeft, height - mUnderlineHeight, mTabsContainer.getWidth()/3 + paddingLeft, height, mRectPaint);
            } else {
                canvas.drawRect(paddingLeft, 0, mTabsContainer.getWidth()/3 + paddingLeft, mUnderlineHeight, mRectPaint);
            }
        }
