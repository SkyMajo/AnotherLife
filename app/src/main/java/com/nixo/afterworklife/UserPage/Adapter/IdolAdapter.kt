...
class IdolAdapter(var context: Context, layout:Int, dataList:MutableList<com.nixo.afterworklife.MainPage.Data.DataItem>) : BaseAdapter<com.nixo.afterworklife.MainPage.Data.DataItem>(context,layout,dataList){
    ...
    fun setIdolAdaptereeInterface(infs : FansApi):IdolAdapter{
        this.infs = infs
        return this
    }
    ...
    override fun initView(p0: BaseHolder, position: Int) {
        ...
        tvUnflow.click {
            tvFlowed.visibility = View.VISIBLE
            tvUnflow.visibility = View.GONE
            infs!!.pm(mDataList[position].user_id.toString())
        }
        tvFlowed.click {
            tvUnflow.visibility = View.VISIBLE
            tvFlowed.visibility = View.GONE
