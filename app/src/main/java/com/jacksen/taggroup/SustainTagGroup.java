...
public class SustainTagGroup extends ViewGroup {
    ...
    public SustainTagGroup(Context context) {
        this(context, null);
    }

    public SustainTagGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SustainTagGroup(Context context, AttributeSet attrs, int defStyleAttr) {
