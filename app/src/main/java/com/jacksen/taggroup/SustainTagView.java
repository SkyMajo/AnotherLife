...
public class SustainTagView extends AppCompatTextView implements Checkable {
    ...
    public SustainTagView(Context context) {
        this(context, null);
    }

    public SustainTagView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SustainTagView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
